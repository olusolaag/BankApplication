...
public class StaffServiceImpl implements StaffService {
	...
	public AccountDetailsStaffResponse getAccountDetails(Long accountNo) {
		Account account = accountRepo.findById(accountNo).orElseThrow(()-> new NoDataFoundException("Account not found"));
		...
		response.setCustomer(account.getCustomer().getFullName());
		response.setTransaction(account.getTransaction());		
		return response;
	...
	@Override
	public ApprovedBeneficiaryResponse approveBeneficiary(ApprovedBeneficiaryRequest request) {
		//Retrieve the customer
				...
				ApprovedBeneficiaryResponse response = new ApprovedBeneficiaryResponse();
				response.setApproved(toBeApproved.getApproved());
				response.setBeneficiaryAccount(toBeApproved.getAccountNo());
				response.setFromCustomer(customer.getUserId());
	...
	public List<CustomerSummary> getCustomers() {
		...
		for(Customer customer : customers) {
			...
			summary.setCreatedDate(customer.getCreatedDate());
